...
public class IndicatorCircle3 extends BaseProgressIndicator {

    private float transitionX;
    private int alpha = 255;
    private Paint paint;

    public IndicatorCircle3(Context context) {
        super(context);
        init();
    }

    public IndicatorCircle3(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public IndicatorCircle3(Context context, AttributeSet attrs, int defStyleAttr) {
